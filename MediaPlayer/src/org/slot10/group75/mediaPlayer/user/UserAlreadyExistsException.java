...
/**
 * Thrown when to try to create or rename a user and a user with this
 * name already exists.
 * 
...
public class UserAlreadyExistsException extends Exception {
	private static final long serialVersionUID = 6920255462748923186L;
	
	public UserAlreadyExistsException() {
		super("Benutzer existiert bereits");
	}
}
