...
/**
 * Thrown when you try to login a user with the wrong data.
 * 
 * @author	Jiacheng Qian (2783671) 
 * @author	Stefan Hahn (2837462) 
 * @author	Andreas Mannsdörfer (2801964)
 */
public class InvalidUserLoginDataException extends Exception {
	private static final long serialVersionUID = 6743342285217370636L;
