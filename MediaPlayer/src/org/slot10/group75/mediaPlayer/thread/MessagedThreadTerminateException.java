...
/**
 * Used to terinate a running thread.
 * 
 * @author	Jiacheng Qian (2783671) 
 * @author	Stefan Hahn (2837462) 
 * @author	Andreas Mannsdörfer (2801964)
 */
public class MessagedThreadTerminateException extends Exception {
	private static final long serialVersionUID = 8433517026509380407L;
}
