...
/**
 * Used to indicate no operation should be done in a thread.
 * 
 * @author	Jiacheng Qian (2783671) 
 * @author	Stefan Hahn (2837462) 
 * @author	Andreas Mannsdörfer (2801964)
 */
public class MessagedThreadNoOperationException extends Exception {
	private static final long serialVersionUID = 2284264284921781767L;
}
